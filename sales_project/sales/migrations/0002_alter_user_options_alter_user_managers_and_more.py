...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='sale',
            name='product_line',
            field=models.CharField(choices=[('aditivo', 'Aditivo'), ('aqua', 'Aqua'), ('aves', 'Aves'), ('pet', 'Pet'), ('ruminantes', 'Ruminantes'), ('suinos', 'Suínos'), ('revenda', 'Revenda'), ('racoes', 'Rações Vaccinar')], max_length=20),
        ),
        migrations.AlterField(
            model_name='user',
            name='email',
